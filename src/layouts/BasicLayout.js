  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <ul className="social">
        ...
        <li>
          <a
            href="https://twitter.com/foxchain_tech"
            target="_blank"
            title="Twitter"
          >
            <Twitter />
        ...
        <li>
          <a
            href="https://t.me/fox_tech_official"
            target="_blank"
            title="Telegram"
          >
            <Telegram />
        ...
        <li>
          <a
            href="https://www.youtube.com/channel/UCtn0P_hP0TKMFwjoYyUUAgg"
            target="_blank"
            title="Youtube"
          >
            <Youtube />
        ...
        <li>
          <a
            href="https://mirror.xyz/0x9918a0c87861D5BBAB94BBCE8c59604B3C01d2C8"
            target="_blank"
            title="Mirror"
          >
            <Mirror />
